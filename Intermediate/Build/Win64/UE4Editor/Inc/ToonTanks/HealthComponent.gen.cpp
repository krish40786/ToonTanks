...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHealthComponent_Statics::Class_MetaDataParams[] = {
		...
		{ "Comment", "//BluprintSpawnableComponent is what is going to let us add it to componenets directly in blueprints\n" },
		{ "IncludePath", "HealthComponent.h" },
		{ "ModuleRelativePath", "HealthComponent.h" },
		{ "ToolTip", "BluprintSpawnableComponent is what is going to let us add it to componenets directly in blueprints" },
	};
#endif
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UHealthComponent, 3627302619);
